...
--set-env-vars REDIS_HOST=10.126.55.187,REDIS_PORT=6379,REDIS_LIST_NAME=mylist,REDIS_LIST_LENGTH=100,MAX_INSTANCE_COUNT=50,CONSUMER_PROJECT_ID=sohansm-project,CONSUMER_REGION=us-central1,CONSUMER_SERVICE_NAME=redis-scaler \
--region us-central1 \
--network=crf-vpc \
--subnet=crf-vpc \
